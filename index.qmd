...
This is a training workshop for (aspiring) scientists offered by the Australian National University (ANU) Biological Data Science Institute (BDSI). 

The workshop is meant for ANU staff or students who wish to upskill in using Quarto (next generation R Markdown) to write dynamic documents. It is expected that the participants know and use at least one of the following languages: Python, R, or Julia.
