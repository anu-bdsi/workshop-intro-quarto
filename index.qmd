...
The workshop aims to equip participants with the skills to write reproducible research documents using Quarto (an open-source scientific and technical publishing system). It is expected that the participants know and use at least Python, R, or Julia to get the most out of the workshop.
